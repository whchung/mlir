...
// CHECK-LABEL: define void @miopen_op_conv2d_f32(float* %{{.*}}, float* %{{.*}}, float* %{{.*}}) {
...
// CHECK-LABEL: define void @miopen_op_conv2d_f16(half* %{{.*}}, half* %{{.*}}, half* %{{.*}}) {
...
// CHECK-LABEL: define void @miopen_op_conv2d_bf16(i16* %{{.*}}, i16* %{{.*}}, i16* %{{.*}}) {
